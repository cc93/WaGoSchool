(function webpackUniversalModuleDefinition(root, factory) {
    ...
    /******/([
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            if (false) {
                (function () {
                    ...
                    var id = "_v-00295bb6/vue-swiper.vue"
                    if (!module.hot.data) {
        ...
        /***/ function (module, exports) {
            ...
            //              v-el:swiper-wrap
            //              :style="{'transform' : 'translate3d(' + translateX + 'px,' + translateY + 'px, 0)',transition: transition}"
            ...
            exports.default = {
                ...
                methods: {
                    initData: function initData() {
                        ...
                        this.count = this.slideEls.length;
                        if (this.playSection.length == 0) {
                           this.playSection = [1, this.count];
                        }
                        this.setPlayPages(this.playSection);
                        console.log('count = ' + this.slideEls.length);
                        if (this.play) {
                            this.startPlay();
                        }
                    },
                    ...
                    startPlay: function startPlay() {
                        ...
                        if (me.loop) {
                            me.intervalId = setInterval(function () {
                                if (me.playIndex == me.playPages.length) {
                                    me.playIndex = 0;
                                }
                                me.setPage(me.playPages[me.playIndex]);
                                me.playIndex++;
                        ...
                        this.$emit('on-play-start', this.currentPage);
                    ...
                    stopPlay: function stopPlay() {
                        ...
                        this.$emit('on-play-stop', this.currentPage);
                    ...
                    setPlayPages: function setPlayPages(playSection) {
                        if (playSection.length == 2) {
                            //[2,3]
                            //[2,5]
                            for (var i = playSection[0]; i <= playSection[1]; i++) {
                                console.log('i = ' + i);
                                this.playPages.push(i);
                            }
                        }
                        if (playSection.length > 2) {
                            //[2,3,4,8,10]
                            this.playPages = playSection;
                            console.log('playPages = ' + this.playPages);
                        }
                    ...
                    _onPlayStart: function _onPlayStart() {
                    },
                    _onPlayStop: function _onPlayStop() {
                    },
                    _onPlayEnd: function _onPlayEnd() {
                    },
                    _onPlaying: function _onPlaying() {
                    }
                },
                events: {
                    'slide-change-start': function (currentPage) {
                ...
                watch: {
                    ...
                    'speed': function (val) {
                        if(this.play){             //如果play正在进行,则需要重启interval使新的speed生效
                            this.restartPlay();
                        }
